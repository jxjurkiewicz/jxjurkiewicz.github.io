    ...
    >
      <div className="relative -top-14">
        ...
        <h1
          data-aos="fade-in"
          data-aos-duration="2000"
          className="font-orbitron text-xl xsm:text-3xl md:text-5xl lg:text-6xl xl:text-7xl mb-1 md:mb-5 font-extrabold tracking-wide text-light text-center sm:text-left"
        >
          Jakub Jurkiewicz.
        </h1>
