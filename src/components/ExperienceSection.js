...
export default function ExperienceSection() {
  return (
    <section className="mx-auto mb-48 max-w-screen-lg">
      ...
      <ul className="mb-32 grid justify-items-center items-stretch justify-center grid-cols-[repeat(auto-fit,minmax(90px,90px))] gap-7 sm:grid-cols-[repeat(auto-fit,minmax(110px,110px))] sm:gap-8 md:grid-cols-[repeat(auto-fit,minmax(125px,125px))] lg:grid-cols-[repeat(auto-fit,minmax(140px,140px))]">
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <p className="mb-10 w-1/2 mx-auto text-center text-dark leading-tight text-lg">
